    ...
    SWIFTSLIDER = {
        ...
        prepareFirstSlide: function( i, sliderInstance ) {
            ...
            if ( sliderInstance.find( '.swiper-slide-active video' ).length > 0 ) {
                ...
                if ( !jQuery( 'html' ).hasClass( 'no-video' ) && !( isMobileAlt && !('playsInline' in document.createElement('video')) ) ) {
        ...
        slideTransitionEnd: function( e, delay ) {
            ...
            sliderInstance.find( '.swiper-slide' ).each(
                function( i ) {
                    ...
                    if ( slideHasVideo && ( jQuery( 'html' ).hasClass( 'no-video' ) || ( isMobileAlt && !('playsInline' in document.createElement('video')) ) ) ) {
                        slideVideo.remove();
                        slideHasVideo = false;
                    }
