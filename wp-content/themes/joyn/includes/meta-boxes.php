		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
					...
					'multiple' => false,
					'std'  => 'standard',
					'desc' => __('Choose the size that you would like the item to show as with the Multi-Size Masonry Portfolio setup. This will only affect that asset.', 'swiftframework')
				),
			)
		);
