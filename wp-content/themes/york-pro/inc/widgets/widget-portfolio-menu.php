...
class York_Portfolio_Menu extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Portfolio Menu', 'york-pro' ), // Name
            array( 
    ...
    function form( $instance ) {
        ...
        <p>
        <label for="<?php echo $this->get_field_id( 'loop' ); ?>"><?php esc_html_e('Portfolio Loop:', 'york-pro') ?></label>
        <select id="<?php echo $this->get_field_id( 'loop' ); ?>" name="<?php echo $this->get_field_name( 'loop' ); ?>" class="widefat">
            <option <?php if ( 'Most Recent' == $instance['loop'] ) echo 'selected="selected"'; ?>><?php esc_html_e('Most Recent', 'york-pro') ?></option>
            <option <?php if ( 'Random' == $instance['loop'] ) echo 'selected="selected"'; ?>><?php esc_html_e('Random', 'york-pro') ?></option>    
        </select>
        </p>
